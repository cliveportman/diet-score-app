        ...
        <TwContainer twc="flex-1 bg-slate-950">
            <TwContainer twc="flex-1 flex-col justify-between px-3 pt-12">
                <TwContainer twc={"flex-1 flex-col justify-start"}>
                    ...
                    <TwText variant="large" twc={"text-slate-300 mb-6"}>To <Text style={{ fontWeight: 600 }}>add a serving</Text> tap the food category.</TwText>
                    <TwText variant="large" twc={"text-slate-300 mb-6"}>To <Text style={{ fontWeight: 600 }}>remove a serving</Text> press and hold the food category.</TwText>
                    <TwText variant="large" twc={"text-slate-300 mb-6"}>You can practice on the two foods above.</TwText>
                </TwContainer>
                <TwContainer twc={"flex-1 flex-col items-center justify-end"}>
                    <TouchableOpacity tw={"flex-col justify-center items-center text-center text-white border border-slate-800 bg-slate-900 w-32 h-32 rounded-full mb-16"} onPress={handleContinue}>
