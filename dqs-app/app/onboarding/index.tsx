        ...
        <TwContainer twc="flex-1 bg-slate-950">
            <TwContainer twc="flex-1 flex-col justify-between px-3 pt-12">
                <TwContainer twc={"flex-1 flex-col justify-start"}>
                    <TwText variant="title" twc={""}>What?</TwText>
                    <TwText variant="large" twc={"text-slate-300 mb-6"}>This app is mainly intended for endurance athletes who've read the book <Text style={{ fontStyle: 'italic'}}>Racing Weight</Text> by Matt Fitzgerald. But can be used by anyone who wants to improve their diet.</TwText>
                    <TwText variant="large" twc={"text-slate-300 mb-6"}>For athletes, the principle is that by working towards your optimal racing weight, you'll perform better in your races.</TwText>
