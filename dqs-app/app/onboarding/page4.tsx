        ...
        <TwContainer twc="flex-1 bg-slate-950">
            <TwContainer twc="flex-1 flex-col justify-between px-6">
                <TwContainer twc={"flex-1 flex-col justify-end"}>
                    ...
                    <TwText variant="subtitle" twc={"text-slate-300 mb-6"}>Each day, record your dietary intake using the food categories provided.</TwText>
                    <TwText variant="subtitle" twc={"text-slate-300 mb-6"}>Nutritious foods will raise your score, unhealthy foods will lower it.</TwText>
                    <TwText variant="subtitle" twc={"text-slate-300 mb-6"}>Aim for as high a score as you can.</TwText>
                </TwContainer>
